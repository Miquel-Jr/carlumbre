                    ...
                    <?php foreach ($services as $service): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger btn-sm btn-delete" onclick="deleteService('<?= $service['id'] ?>')">
                                    Eliminar
                                </button>

                                <button
                                    type="button"
                                    class="btn btn-sm btn-info btn-whatsapp"
                ...
                <form method="POST" action="/services/whatsapp" id="whatsappForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary" id="toggleClientsBtn">Desmarcar todos</button>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea
                                class="form-control"
                                id="modalFinalMessage"
                                name="final_message"
                                rows="8"
                                required></textarea>
                            <small class="text-muted">
                                Puedes modificar el texto antes de enviar. Usa {cliente} si quieres que el nombre se reemplace automáticamente por cada cliente seleccionado.
                            </small>
                        </div>
                    </div>
